...
public class VistaVentas implements Initializable {
    @FXML
    JFXButton updateTable,btnVende,exit,add;
    @FXML
    TableView tablaProds;
    @FXML
    TableColumn prod,nameProd,price,promo;

    @Override
    public void initialize(URL location, ResourceBundle resources)
    {
        //updateTable.setOnAction(updatedTable);
        btnVende.setOnAction(borrar);
    ...
    /*public EventHandler<ActionEvent> updatedTable = new EventHandler<ActionEvent>()
    {
        ...
        {
            tablaProds.setItems(productosDAO.findSome());
        }
    };*/
    ...
    public void showAdd()
    {
        try
        {
            ...
            Parent root= null;
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/sample/Vistas/addVentaFormat.fxml"));
